...
VDPRegisters:
	...
	dc.b $28 ;-$02: Pattern table for Scroll Plane A at VRAM $A000 (bits 3-5 = bits 13-15)
	dc.b $00 ; $03: Pattern table for Window Plane at VRAM $0000 (disabled) (bits 1-5 = bits 11-15)
	dc.b $06 ;-$04: Pattern table for Scroll Plane B at VRAM $C000 (bits 0-2 = bits 11-15)
	...
	dc.b $00 ; $0B: External interrupts off, V scroll fullscreen, 00: H scroll full, 02: H scroll tiles, 03: H scroll lines
	...
	dc.b $11 ; $10: Scroll plane size: 00:32x32 tiles, 01:64x32 tiles, 11:64x64 tiles
